...
def sgp4(satrec, tsince, whichconst=None):
     ...
     if nm <= 0.0:
         ...
         satrec.error_message = 'mean motion is less than zero'
         satrec.error = 2;
         #  sgp4fix add return
         return false, false;
     ...
     if satrec.method == 'd':
         ...
         if ep < 0.0 or ep > 1.0:
             ...
             satrec.error_message = ('perturbed eccentricity not within'
                                     ' range 0.0 <= e <= 1.0')
             satrec.error = 3;
             #  sgp4fix add return
             return false, false;
     ...
     if pl < 0.0:
         ...
         satrec.error_message = 'semilatus rectum is less than zero'
         satrec.error = 4;
         #  sgp4fix add return
         return false, false;
     ...
     if mrt < 1.0:
         ...
         satrec.error_message = ('mrt is less than 1.0 indicating'
